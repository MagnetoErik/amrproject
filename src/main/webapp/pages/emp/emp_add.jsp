...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String addUrl = basePath + "emp/doAddEmp.action" ;
%>
							...
							<form class="form-horizontal" action="<%=addUrl%>" id="myform" method="post" enctype="multipart/form-data">
								<fieldset>
									...
									<div class="form-group" id="nameDiv">
										...
										<div class="col-md-5">
											<!-- 定义表单输入组件 -->
											<input type="text" id="name" name="name" value="${newEmp.name}" class="form-control"
												placeholder="请输入雇员姓名">
										</div>
										<!-- 定义表单错误提示显示元素 -->
									...
									<div class="form-group" id="sexDiv">
										<!-- 定义表单提示文字 -->
										<label class="col-md-3 control-label" for="sex男">雇员性别：</label>
										<div class="col-md-5">
									...
									<div class="form-group" id="passwordDiv">
										...
										<div class="col-md-5">
											<!-- 定义表单输入组件 -->
											<input type="password" id="password" name="password" value="${newEmp.password}" class="form-control"
												placeholder="请输入登录密码">
										</div>
										<!-- 定义表单错误提示显示元素 -->
									...
									<div class="form-group" id="salaryDiv">
										...
										<div class="col-md-5">
											<!-- 定义表单输入组件 -->
											<input type="text" id="salary" name="salary" ${newEmp.salary} class="form-control"
												placeholder="请输入基本工资">
										</div>
										<!-- 定义表单错误提示显示元素 -->
