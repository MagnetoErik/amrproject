...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String doEditUrl = basePath + "emp/doEdit.action" ;
%>
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title"><strong>修改管理员</strong></h3>
						</div>
						<!-- /.box-header -->
						<div class="">
							<form class="form-horizontal" action="<%=doEditUrl%>" id="myform" method="post">
								...
								<fieldset>
									<div class="form-group" id="eidDiv">
										...
										<div class="col-md-5">
											<!-- 定义表单输入组件 -->
											<input type="text" readonly="readonly" id="eid" name="eid" class="form-control"
												placeholder="请输入雇员编号" value="${emp.eid}">
										</div>
										<!-- 定义表单错误提示显示元素 -->
