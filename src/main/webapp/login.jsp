...
//	String loginUrl = basePath + "emp/login.action" ;
%>
				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="${pageContext.request.contextPath}/emp/login.action" method="post" class="form-horizontal" id="myform">
